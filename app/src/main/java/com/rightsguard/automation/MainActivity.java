...
public class MainActivity extends AppCompatActivity {
    ...
    private MaterialButton btnUiDump;
    ...
    private void initViews() {
        ...
        btnUiDump = findViewById(R.id.btn_ui_dump);
