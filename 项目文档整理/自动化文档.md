...
32. 🎯 在观看历史中查找并点击侵权视频 (V3.3新增) ⭐️
  ...
  └─ 32.6 🎉 侵权视频已打开
  ↓
33. 🎯 智能人脸检测截图 (V3.2新增 / V3.4优化) ⭐️
  ├─ 33.1 📝 初始化人脸检测器
  │   ├─ 使用Google ML Kit人脸检测
  │   ├─ 准确模式: PERFORMANCE_MODE_ACCURATE
  │   ├─ 最小人脸大小: 0.5f (V3.4优化: 0.4f→0.5f 减少误检) ⭐️
  │   └─ 启用人脸追踪
  ├─ 33.2 📊 确定截图参数
  │   ├─ 视频<30秒 → 截4张
  │   ├─ 视频≥30秒 → 截5张
  ...
  │   │   ├─ 🔍 ML Kit检测人脸
  │   │   ├─ ✅ 检测到人脸:
  │   │   │   ├─ 验证人脸大小(V3.4优化: 宽>20% AND 高>20% AND 面积>3%) ⭐️
  │   │   │   ├─ 有效人脸 → 保存图片到相册
  ...
  │   │       └─ 继续扫描
  │   └─ 直到保存足够数量的图片或到达视频时长
  ├─ 33.5 🖼️ 兜底截图逻辑 (V3.4新增) ⭐️
  │   ├─ 判断条件: savedCount == 0 (全程未检测到人脸)
  │   ├─ 依次保存3张兜底帧到相册:
  │   │   ├─ "侵权视频_开始_1.0秒_时间戳.png"
  │   │   ├─ "侵权视频_中间_XX.X秒_时间戳.png"
  │   │   └─ "侵权视频_结尾_XX.X秒_时间戳.png"
  │   └─ 正常检测到人脸时跳过此步骤
  ├─ 33.6 ✅ 智能截图完成
